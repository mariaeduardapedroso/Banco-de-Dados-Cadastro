...
INSERT INTO  Locais ( Local, Tipo, Limite, DataCriacao, UsuarioCriacao, DataAlteracao, UsuarioAlteracao)VALUES('Cartão Nu', 'C', 2000, GETDATE(), 'maria.pedroso', GETDATE(), 'maria.pedroso')
