...
INSERT INTO  Planos(IdPlano, Plano, Valor, PlanoAtivo, DataCriacao, UsuarioCriacao, DataAlteracao, UsuarioAlteracao ) VALUES(6, 'Diário', 44683, 0, GETDATE(), 'maria.pedroso', GETDATE(), 'maria.pedroso' )
